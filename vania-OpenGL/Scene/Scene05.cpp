...
void Scene05::load() {
	...
	..............................................................................*/
	// map
	this->tiledMap->loadMapData("TileObject2", "./Maps/scene_Scene05-BackGround2.csv");
	this->tiledMap->loadMapData("TileObject", "./Maps/scene_Scene05-BackGround.csv");
	this->tiledMap->loadMapData("ColliderObject", "./Maps/scene_Scene05-Ground.csv");
	this->tiledMap->loadMapData("CameraRange", "./Maps/scene_Scene05-Camera.csv");
	this->tiledMap->loadMapData("Range", "./Maps/scene_Scene05-Range.csv");
	// check point
	this->tiledMap->loadMapData("Player", "./Maps/scene_Scene05-Player.csv");
	// item
	this->tiledMap->loadMapData("Orb", "./Maps/scene_Scene05-Orb.csv");
}
